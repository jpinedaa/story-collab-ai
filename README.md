...
[Watch in Youtube](https://youtu.be/VYJJVNv73L0?si=Tt-Gs75gINKLsJeF)
...
2. Set your api key and model from [NVIDIA NIMS](https://build.nvidia.com/explore/discover)
    * Sign up and you can get a free api key [here](https://build.nvidia.com/explore/discover#llama3-70b) (Click on 'get api key' at top right corner of code block)
4. Click save
